...
namespace CZZD.ERP.SQLServerDAL
{
    public class StockManage : IStock
    {
        ...
        public int AddHistory(BllHistoryStockTable historyStockTable)
        {
            ...
            while (i < 10)
            {
                try
                {
                    ...
                    stockParam[4].Value = CConstant.INIT_STATUS;
                    ...
                    foreach (BllHistoryStockLineTable lineModel in historyStockTable.Items)
                    {
                        ...
                        lineParam[6].Value = CConstant.INIT_STATUS;
                        ...
                        else
                        {
                            ...
                            stockParam2[4].Value = CConstant.INIT_STATUS;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from get_stock_adjustment_search_view");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.* from get_stock_adjustment_search_view T");
        ...
        public DataSet GetPrintList(string strWhere)
        {
            ...
            strSql.Append("CREATE_NAME, CREATE_DATE_TIME, LAST_UPDATE_NAME, LAST_UPDATE_TIME FROM get_stock_adjustment_search_view ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetStockList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                strSql.Append("order by T.WAREHOUSE_CODE asc, PRODUCT_NAME asc");
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT * FROM bll_stock_search_view ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
            strSql.Append(" ORDER BY WAREHOUSE_CODE,PRODUCT_NAME ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT WAREHOUSE_CODE, WAREHOUSE_NAME, PRODUCT_CODE, PRODUCT_NAME, PRODUCT_NAME_JP,SPEC, UNIT_CODE, UNIT_NAME, QUANTITY, ");
            ...
            strSql.Append(" order by WAREHOUSE_CODE asc, PRODUCT_NAME asc");
            return DbHelperSQL.Query(strSql.ToString());
        }
        ...
        public int GetDelayRecordCount(string strWhere)
        {
            ...
            strSql.Append(" NAME, SPEC, QUANTITY, UNIT_NAME from get_delay_view T ");
        ...
        public DataSet GetDelayList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append("UNIT_NAME from get_delay_view T ");
        ...
        public DataSet GetDelayPrintList(string strWhere)
        {
            ...
            strSql.Append(" CREATE_NAME, CREATE_DATE_TIME,LAST_UPDATE_NAME, LAST_UPDATE_TIME FROM get_delay_view T ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
