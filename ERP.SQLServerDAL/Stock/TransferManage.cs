...
namespace CZZD.ERP.SQLServerDAL
{
    public class TransferManage:ITransfer
    {
        ...
        public int Add(BllTransferReceiptTable TRModel)
        {
            ...
            while (i < 10)
            {
                try
                {
                    ...
                    transferParam[5].Value = CConstant.INIT_STATUS;
                    ...
                    foreach (BllTransferReceiptLineTable TRLModel in TRModel.Items)
                    {
                        ...
                        TRLParam[5].Value = CConstant.INIT_STATUS;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from get_transfer_receipt_search_view");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.* from get_transfer_receipt_search_view T");
        ...
        public DataSet GetPrintList(string strWhere)
        {
            ...
            strSql.Append("CREATE_NAME, CREATE_DATE_TIME, LAST_UPDATE_NAME, LAST_UPDATE_TIME FROM get_transfer_receipt_search_view");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
