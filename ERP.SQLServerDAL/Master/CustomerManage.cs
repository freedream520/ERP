    ...
    public class CustomerManage:ICustomer
    {
        ...
        public bool Add(CZZD.ERP.Model.BaseCustomerTable model)
        {
            try
            {
                ...
                strSql.Append("CODE,NAME,NAME_SHORT,NAME_ENGLISH,ZIP_CODE,ADDRESS_FIRST,ADDRESS_MIDDLE,ADDRESS_LAST,PHONE_NUMBER,FAX_NUMBER,MOBIL_NUMBER,CONTACT_NAME,EMAIL,URL,MEMO,MEMO2,TYPE,CLAIM_FLAG,CLAIM_CODE,CURRENCE_CODE,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME,NAME_JP)");
                strSql.Append(" values (");
                strSql.Append("@CODE,@NAME,@NAME_SHORT,@NAME_ENGLISH,@ZIP_CODE,@ADDRESS_FIRST,@ADDRESS_MIDDLE,@ADDRESS_LAST,@PHONE_NUMBER,@FAX_NUMBER,@MOBIL_NUMBER,@CONTACT_NAME,@EMAIL,@URL,@MEMO,@MEMO2,@TYPE,@CLAIM_FLAG,@CLAIM_CODE,@CURRENCE_CODE,@STATUS_FLAG,@CREATE_USER,GETDATE(),@LAST_UPDATE_USER,GETDATE(),@NAME_JP)");
                SqlParameter[] cParam = {
                ...
                cParam[20].Value = CConstant.INIT_STATUS;
                ...
                dParam[10].Value = CConstant.INIT_STATUS;
        ...
        public bool Update(CZZD.ERP.Model.BaseCustomerTable model)
        {
            ...
            cParms[20].Value = CConstant.INIT_STATUS;            
        ...
        {
            StringBuilder strSql = new StringBuilder();          
            strSql.AppendFormat("update BASE_CUSTOMER  set STATUS_FLAG = {0}", CConstant.DELETE_STATUS);
            strSql.Append(" where CODE=@CODE ");
            SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,50)};
            parameters[0].Value = CODE;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select CODE,NAME,NAME_SHORT,NAME_ENGLISH,ZIP_CODE,ADDRESS_FIRST,ADDRESS_MIDDLE,ADDRESS_LAST,PHONE_NUMBER,FAX_NUMBER,MOBIL_NUMBER,CONTACT_NAME,EMAIL,URL,MEMO,MEMO2,customer_type,customer_claim,CLAIM_CODE,CURRENCE_CODE,CURRENCE_NAME,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME,NAME_JP ,CLAIM_NAME");
