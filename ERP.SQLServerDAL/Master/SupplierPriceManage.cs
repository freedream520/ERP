    ...
    public class SupplierPriceManage:ISupplierPrice
    {
        ...
        public bool Add(CZZD.ERP.Model.BaseSupplierPriceTable model)
		{
            ...
            if (Exists(model.SUPPLIER_CODE, model.PRODUCT_CODE, model.UNIT_CODE, model.CURRENCY_CODE))
            {
                ...
                parameters[5].Value = CConstant.NORMAL_STATUS;
		...
		{			
			StringBuilder strSql=new StringBuilder();	
            strSql.AppendFormat("update BASE_SUPPLIER_PRICE  set STATUS_FLAG = {0}", CConstant.DELETE_STATUS);
            strSql.Append(" where SUPPLIER_CODE=@SUPPLIER_CODE and PRODUCT_CODE=@PRODUCT_CODE and UNIT_CODE=@UNIT_CODE and CURRENCY_CODE=@CURRENCY_CODE ");
			SqlParameter[] parameters = {
					new SqlParameter("@SUPPLIER_CODE", SqlDbType.VarChar,50),
					new SqlParameter("@PRODUCT_CODE", SqlDbType.VarChar,50),
		...
		{			
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 SUPPLIER_CODE,PRODUCT_CODE,UNIT_CODE,CURRENCY_CODE,PRICE,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME,SUPPLIER_NAME,PRODUCT_NAME,UNIT_NAME,CURRENCY_NAME from base_sprice_view ");
			strSql.Append(" where SUPPLIER_CODE=@SUPPLIER_CODE and PRODUCT_CODE=@PRODUCT_CODE and UNIT_CODE=@UNIT_CODE and CURRENCY_CODE=@CURRENCY_CODE ");
		...
		public DataSet GetList(string strWhere)
		{
            ...
            strSql.Append(" FROM base_sprice_view ");
			if(strWhere.Trim()!="")
			{
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from base_sprice_view");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.* from base_sprice_view T");
