    ...
    public class ProductGroupManage:IProductGroup 
    {
        ...
        public bool Add(CZZD.ERP.Model.BaseProductGroupTable model)
        {
            ...
            if (Exists(model.CODE))
            {
                ...
                parameters[3].Value = CConstant.NORMAL_STATUS;
            ...
            else
            {
                ...
                strSql.Append("CODE,NAME,PARENT_CODE,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME, INDICATES_ORDER)");
                strSql.Append(" values (");
                strSql.Append("@CODE,@NAME,@PARENT_CODE,@STATUS_FLAG,@CREATE_USER,GETDATE(),@LAST_UPDATE_USER,GETDATE(), @INDICATES_ORDER)");
                SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,20),
					new SqlParameter("@NAME", SqlDbType.NVarChar,255),
					new SqlParameter("@PARENT_CODE", SqlDbType.VarChar,20),
        ...
        {			
			StringBuilder strSql=new StringBuilder();			
            strSql.AppendFormat("update BASE_PRODUCT_GROUP  set STATUS_FLAG = {0}", CConstant.DELETE_STATUS);
            strSql.Append(" where CODE=@CODE ");
			SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,50)};
			parameters[0].Value = CODE;
		...
		{			
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 CODE,NAME,PARENT_CODE,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME,PARENT_NAME,INDICATES_ORDER from base_group_view ");
			strSql.Append(" where CODE=@CODE ");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select CODE,NAME,PARENT_CODE,PARENT_NAME,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME,INDICATES_ORDER ");
