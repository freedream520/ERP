...
namespace CZZD.ERP.Model
{
    public class BllReceiptPlanTable
    {
        ...
        private int _included_tax_status;
        private string _line_memo;
        private string _purchase_quotation_number;
        ...
        public int INCLUDED_TAX_STATUS
        {
            get { return _included_tax_status; }
            set { _included_tax_status = value; }
        }

        public string LINE_MEMO
        {
            set { _line_memo = value; }
            get { return _line_memo; }
        }

        /// <summary>
        /// 
        /// </summary>
        public string PURCHASE_QUOTATION_NUMBER
        {
            set { _purchase_quotation_number = value; }
            get { return _purchase_quotation_number; }
        }
        #endregion Model
    }
}
